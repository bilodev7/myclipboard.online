  ...
  return (
    <div className="clipboard-entry group hover:border-primary/30 hover:shadow-glow-sm p-3 sm:p-4 rounded-lg border border-surface-hover bg-surface/50 backdrop-blur-sm transition-all duration-200">
      <div className="flex justify-between items-center mb-2 sm:mb-3">
        ...
        <div className="flex space-x-2 opacity-90 group-hover:opacity-100 transition-opacity">
          <button
            onClick={() => onCopy(entry.content, entry.id)}
            className="flex items-center justify-center w-7 h-7 rounded-full bg-surface hover:bg-surface-hover border border-surface-hover text-text-primary hover:text-primary transition-colors"
